...
% Complete tokenizer configuration example available at:
% code/part1/chapter01/tokenizer_special_tokens_demo.py
\begin{lstlisting}[language=Python, caption={Automatic special token insertion with detailed inspection}]
