...
% Pros and Cons
\node[label, align=left, text width=2.5cm] at (1, -0.5) {\textcolor{gptgreen}{$\checkmark$} Pre-trained\\$\checkmark$ Effective\\$\times$ Single vector};
\node[label, align=left, text width=2.5cm] at (4, -0.5) {\textcolor{gptgreen}{$\checkmark$} Simple\\$\checkmark$ No params\\$\times$ Poor performance};
\node[label, align=left, text width=2.5cm] at (7, -0.5) {\textcolor{gptgreen}{$\checkmark$} Sparse\\$\checkmark$ No params\\$\times$ Loses nuance};
\node[label, align=left, text width=2.5cm] at (10, -0.5) {\textcolor{gptgreen}{$\checkmark$} Adaptive\\$\checkmark$ Flexible\\$\times$ More complex};
