...
\begin{example}[Traditional UNK Processing]
...
\begin{example}[Subword vs Traditional Tokenization]
\begin{lstlisting}[language=Python]
...
\begin{figure}[h]
\centering
% \input{part1/chapter02/fig_tokenization_comparison}
...
\begin{example}[UNK Token Handling]
\begin{lstlisting}[language=Python]
import torch
