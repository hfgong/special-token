...
\begin{comment}
Feedback: After Subword revolution, is UNK eliminated? List the popular models if they use UNK: BERT, T5, GPT-2, GPT-3, PALM etc.

STATUS: addressed - added explanation that UNK still exists in modern models with specific examples of when and how it's used
\end{comment}
