...
% Suppress note field in bibliography output while keeping it in .bib for reference
...
\input{part2/chapter06/gui_interface_tokens}

% Part III: Advanced Special Token Techniques
\part{Advanced Special Token Techniques}

\chapter{Special Token Design and Implementation}
% Design foundations
...
\chapter{Special Token Optimization and Training}
...
% Attention optimization from Chapter 10
\input{part4/chapter10/attention_masks}

\chapter{Advanced Special Token Techniques}
\input{part3/chapter09/introduction}
% Advanced token types from Chapter 7
\input{part3/chapter07/memory_tokens}
\input{part3/chapter07/tool_interaction_tokens}
\input{part3/chapter07/adapter_tokens}
\input{part3/chapter07/task_specific_prompts}
% Advanced control and reasoning tokens from Chapter 8
\input{part3/chapter08/chain_of_thought}
\input{part3/chapter08/control_tokens}
\input{part3/chapter08/tool_use_tokens}
% Advanced techniques from Chapter 9
\input{part3/chapter09/reasoning_tokens}
\input{part3/chapter09/sparse_attention}
\input{part3/chapter09/dynamic_selection}
\input{part3/chapter09/token_pruning}
\input{part3/chapter09/token_recycling}

% Part IV removed - content integrated into Part III
